...
<form method="post" enctype="multipart/form-data">
	<fieldset style="display: inline-flex; background-color: orange;">
	<legend><font size="+2" style="color: lime;"><strong>Registration</strong></font></legend>
    ...
    <b>Address : </b><textarea placeholder="Input Address" name="address" required ></textarea>
<fieldset style="display: inline-flex; background-color: orange;"><legend><strong>Verification</strong></legend><p><?php
error_reporting(1);
echo $res." = ";
?>
...
<br />
<p style="color: lime; font: serif;">1. Fields marked * are required to be filled.<br/>2. The password must contain one uppercase, one lowercase, one numeric character and one special character.<br/>
3. Username must be unique.<br/>4. Email Id must be unique.<br /></p>
</body>
</html>